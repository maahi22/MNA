...
-(void)prepareToolbar {
	...
	if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) { // Ipad.
        ...
        self.dismissBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.zoomLockBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.changeDirectionBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.changeLeadBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.changeModeBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.textBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.outlineBarButtonItem.tintColor = [UIColor whiteColor];
        ...
        self.bookmarkBarButtonItem.tintColor = [UIColor whiteColor];
